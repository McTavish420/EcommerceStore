...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"https://ecommstore2019.herokuapp.com/api/auth/login","method":"post","propertyName":"token"},"logout":true,"user":{"url":"/api/auth/user","method":"get","propertyName":"user"}},"_name":"local"}))
