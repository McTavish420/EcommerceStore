...
/* harmony default export */ var _nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  false ? undefined : runtimeConfig.baseURL || process.env._AXIOS_BASE_URL_ || 'http://localhost:3001'; // Create fresh objects for all default header scopes
