...
const mutations = {
  ...
  */
  ...
  remove(state) {
    state.userName = '', state.city = '', state.logStatus = false;
  }
...
/* harmony default export */ var _nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  false ? undefined : runtimeConfig.baseURL || process.env._AXIOS_BASE_URL_ || 'https://ecommstore2019.herokuapp.com/'; // Create fresh objects for all default header scopes
