...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/reviews/review.vue?vue&type=template&id=66ccdc20&
...
// CONCATENATED MODULE: ./pages/reviews/review.vue?vue&type=template&id=66ccdc20&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/reviews/review.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var reviewvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    try {
      let response = await $axios.$get(`${"https://ecommstore2019.herokuapp.com"}/api/products/${route.query.art}`);
      return {
  ...
  methods: {
    ...
    async onAddReview() {
      try {
        ...
        let response = await this.$axios.$post(`${"https://ecommstore2019.herokuapp.com"}/api/review/${this.$route.query.art}`, data);

        if (response.success) {
          this.$router.push({
            path: `/products/${this.$route.query.art}`
          });
        }
      } catch (error) {
        console.log(error);
...
// CONCATENATED MODULE: ./pages/reviews/review.vue?vue&type=script&lang=js&
 /* harmony default export */ var reviews_reviewvue_type_script_lang_js_ = (reviewvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/reviews/review.vue
