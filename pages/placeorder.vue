  ...
  <div class="container-fluid">
    <div class="shipping-address">
      ...
      <div class="col-sm-2">
                        <div class="logo-area">
                            <nuxt-link to="/">
                                <img src="/img/ECOM.png" alt="Logo" class="img-fluid">
                            </nuxt-link>
                        </div>
      </div>
              ...
              <div class="shipping-group">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-7 col-sm-6 col-12">
                    <div class="a-row a-spacing-base" 
                         v-for="product in getCart" :key="product._id">
                      <div class="row">
                        <!-- Product's photo -->
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        >For an item sold by Ecommerce Store: When you click the "Place your order" button, we'll send you an email message acknowledging receipt of your order. Your contract to purchase an item will not be complete until we send you an email notifying you that the item has been shipped.</p>
...
export default {
  ...
  computed: {
    ...mapGetters(['getCart', 'getCartTotalPrice', 'getCartTotalPriceWithTotalPrice'])
  },
