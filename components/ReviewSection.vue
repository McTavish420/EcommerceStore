          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              ...
              <div class="review-sort-type">
                <span class="a-dropdown-container">
                  <span class="a-button a-button-dropdown">
                    <span class="a-button-inner">
                      <span class="a-button-text" style="margin-left: 5px !important">
              ...
              <div class="review-body" v-for="review in reviews" :key="review._id">
                <div class="genome-widget">
                  <a href="#">
                    ...
                    <div class="profile-content">
                      <span class="a-profile-name">{{review.user.userName}}</span>
                    </div>
                  </a>
                </div>
                <div class="a-row">
                ...
                <!-- Review Body -->
                <div class="review-body overflow-auto" style="white-space: wrap !important; text-overflow: clip !important">
